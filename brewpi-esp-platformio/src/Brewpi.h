...
// It appears that CLion, or Cmake or something isn't interpreting the enum properly. Reverting to the #defines
#define BREWPI_SHIELD_DIY 0
#define BREWPI_SHIELD_REV_A 1
#define BREWPI_SHIELD_REV_C 2
#define BREWPI_SHIELD_SPARK_V1 3
#define BREWPI_SHIELD_SPARK_V2 4
...
#if defined(ESP8266_WiFi) && !defined(ESP8266_WiFi_Control)
#define ESP8266_WiFi_Control 1  // Wifi requires WiFi Control as well
#endif

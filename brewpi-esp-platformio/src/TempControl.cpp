...
//				'C', // tempFormat
//                (temp_long_t) 10.0, // heater1_kp
//				600, // heater1_ti
//				60, // heater1_td
//				1, // heater1_infilt
//				4, // heater1_dfilt
//                (temp_long_t) 10.0, // heater2_kp
//				600, // heater2_ti
//				60, // heater2_td
//				1, // heater2_infilt
//				4, // heater2_dfilt
//                (temp_long_t) 10.0, // cooler_kp
//				1800, // cooler_ti
//				200, // cooler_td
//				1, // cooler_infilt
//				4, // cooler_dfilt
//                (temp_long_t) 2.0, // beer2fridge_kp
//				7200, // beer2fridge_ti
//				1200, // beer2fridge_td
//				1, // beer2fridge_infilt
//				4, // beer2fridge_dfilt
//                (temp_long_t) 10.0, // beer2fridge_pidMax
//				120, // minCoolTime
//				180, // minCoolIdleTime
//				4, // heater1PwmPeriod
//				4, // heater2PwmPeriod
...
ControlConstants ccDefaults() {
    ControlConstants ccDef;

    ccDef.tempFormat = 'C';
    ccDef.heater1_kp = 10.0;
    ccDef.heater1_ti = 600;


    ccDef.heater1_td = 60;
    ccDef.heater1_infilt = 1;
    ccDef.heater1_dfilt = 4;
    ccDef.heater2_kp = 10.0;
    ccDef.heater2_ti = 600;
    ccDef.heater2_td = 60;
    ccDef.heater2_infilt = 1;
    ccDef.heater2_dfilt = 4;
    ccDef.cooler_kp = 10.0;
    ccDef.cooler_ti = 1800;
    ccDef.cooler_td = 200;
    ccDef.cooler_infilt = 1;
    ccDef.cooler_dfilt = 4;
    ccDef.beer2fridge_kp = 2.0;
    ccDef.beer2fridge_ti = 7200;
    ccDef.beer2fridge_td = 1200;
    ccDef.beer2fridge_infilt= 1;
    ccDef.beer2fridge_dfilt = 4;
    ccDef.beer2fridge_pidMax = 10.0;
    ccDef.minCoolTime = 120;
    ccDef.minCoolIdleTime = 180;
    ccDef.heater1PwmPeriod = 4;
    ccDef.heater2PwmPeriod = 4;
    ccDef.coolerPwmPeriod = 1200;
    ccDef.mutexDeadTime = 1800;
...
{
	// For the ESP8266, we're using functions that explicitly write control settings/constants

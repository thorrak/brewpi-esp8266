...
bool platform_init()
{
	...
	Serial.print("Passed eeprom initialization");
#ifdef ESP8266_WiFi
	String mdns_id;
...
#endif
	Serial.print("Passed (disabled) wifi code)");
	...
	Serial.print("Passed initialization code");
	eepromAccess.init();
	Serial.print("Returning initialize");
	return initialize;
}
...
size_t ICACHE_FLASH_ATTR _DEFUN(wcstombs, (s, pwcs, n),

...
*/
#ifndef _WIFISERVERFIXED_H_
#define _WIFISERVERFIXED_H_
...
class WiFiServerFixed : public Server {
  private:
    int sockfd;
  ...
  public:
    ...
    WiFiClientFixed accept(){return available();}

...
void LcdDisplay::printStationaryText(){
	...
	printAt_P(0, 2, (flags & LCD_FLAG_DISPLAY_ROOM) ?  PSTR("Room  ") : (extendedSettings.glycol ? STR_Glycol_ : STR_Fridge_));
...
void LcdDisplay::printMode(){
    ...
    case Modes::fridgeConstant:
			lcd.print_P(extendedSettings.glycol ? STR_Glycol_ : STR_Fridge_);
